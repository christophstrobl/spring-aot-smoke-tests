...
public class Conference {
	...
	public String toString() {
		return "Conference(id=" + this.id + ", name=" + this.name + ", date=" + this.date + ", location="
				+ this.location + ", keywords=" + this.keywords + ")";
	}
	...
	public static class ConferenceBuilder {
		...
		public ConferenceBuilder location(GeoPoint location) {
			this.location = location;
			return this;
		}

		public ConferenceBuilder keywords(List<String> keywords) {
			this.keywords = keywords;
			return this;
		}
		...
		public String toString() {
			return "Conference.ConferenceBuilder(id=" + this.id + ", name=" + this.name + ", date=" + this.date
					+ ", location=" + this.location + ", keywords=" + this.keywords + ")";
		}
